      ...
      <div className="flex items-center gap-2 px-4 py-3 border-b border-[#2e2e2e] shrink-0 bg-[#1e1e1e]">
        ...
        <div className="relative shrink-0">
          <button
            ...
            title="Generate code"
            className="p-2 rounded-md border border-[#333] bg-[#242424] hover:bg-[#2a2a2a] text-[#777] hover:text-[#e8e8e8] transition-colors"
          >
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3 py-2 rounded-md border border-[#333] bg-[#242424] hover:bg-[#2a2a2a] text-[#aaa] hover:text-[#e8e8e8] text-xs font-medium transition-colors shrink-0"
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-4 py-2 rounded-md bg-[#ff6c37] hover:bg-[#ff8555] disabled:opacity-50 disabled:cursor-not-allowed text-white text-xs font-bold transition-colors shrink-0 shadow-lg shadow-orange-500/20"
