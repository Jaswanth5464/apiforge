  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center gap-1.5 px-2.5 py-1.5 rounded border border-[#333] bg-[#242424] hover:bg-[#2a2a2a] text-xs text-[#aaa] hover:text-[#e8e8e8] transition-colors"
      >
          ...
          <div className="absolute right-0 top-full mt-1 bg-[#2a2a2a] border border-[#3a3a3a] rounded-lg shadow-xl z-50 py-1 min-w-[180px]">
            <button
              ...
              className={cn(
                ...
                !selectedEnvironmentId ? 'text-[#ff6c37]' : 'text-[#aaa]'
              )}
            >
              No Environment
            </button>
            ...
            {environments.map((env) => (
              <button
                ...
                className={cn(
                  ...
                  env.id === selectedEnvironmentId ? 'text-[#ff6c37]' : 'text-[#aaa]'
                )}
              >
